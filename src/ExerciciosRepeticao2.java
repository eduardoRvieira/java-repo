...
public class ExerciciosRepeticao2 {
    ...
    public static void ex4(Scanner sc) {
        ...
        do {
            System.out.print("Insira o código de usuário (número positivo inteiro): ");
            cod = sc.nextInt();
            
            System.out.print("Insira a senha (número positivo inteiro): ");
            senha = sc.nextInt();
            
            if (cod <= 0 || senha <= 0) {
                System.out.println("ERRO: Ambos código e senha devem ser números positivos maiores que zero.\n");
            } else if (senha == cod) {
                System.out.println("ERRO: A senha não pode ser igual ao código de usuário. Recomeçando...\n");
            } else {
                valido = true;
            }
        } while (!valido);
